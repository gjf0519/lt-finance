...
public class ConsumerUtil {
    ...
    public static DefaultMQPushConsumer orderConsumer(String consumerGroupName,
                                                      String nameServerAddr,
                                                      String topicName,
                                                      MessageListenerOrderly messageListener) throws Exception {
    ...
    public static DefaultMQPushConsumer concurrentConsumer(String consumerGroupName
                    , String nameServerAddr,
                     String topicName,
